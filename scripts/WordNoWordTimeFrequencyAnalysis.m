...
for i = subsSZ
    ...
    eval(['sub',num2str(i),'nonWordFirstLow = ft_freqdescriptives([], nonWordFirstLow);']);
    %eval(['sub',num2str(i),'nonWordSecondHigh = nonWordSecondHigh;']);
    eval(['sub',num2str(i),'nonWordSecondLow = ft_freqdescriptives([], nonWordSecondLow);']);
    %eval(['sub',num2str(i),'nonWordSingleHigh = nonWordSingleHigh;']);
    eval(['sub',num2str(i),'nonWordSingleLow = ft_freqdescriptives([], nonWordSingleLow);']);
    %eval(['sub',num2str(i),'wordFirstHigh = wordFirstHigh;']);
    eval(['sub',num2str(i),'wordFirstLow = ft_freqdescriptives([], wordFirstLow);']);
    %eval(['sub',num2str(i),'wordSecondHigh = wordSecondHigh;']);
    eval(['sub',num2str(i),'wordSecondLow = ft_freqdescriptives([], wordSecondLow);']);
    %eval(['sub',num2str(i),'wordSingleHigh = wordSingleHigh;']);
    eval(['sub',num2str(i),'wordSingleLow = ft_freqdescriptives([], wordSingleLow);']);
    clear nonWordFirstLow nonWordSecondLow nonWordSingleLow wordFirstLow wordSecondLow wordSingleLow
end;
...
nonWordFirstLowSZ = ft_freqgrandaverage(cfg, sub14nonWordFirstLow, sub16nonWordFirstLow,...
    sub17nonWordFirstLow, sub19nonWordFirstLow, sub21nonWordFirstLow, sub23nonWordFirstLow,...
    sub24nonWordFirstLow, sub27nonWordFirstLow, sub28nonWordFirstLow, sub29nonWordFirstLow,...
    sub31nonWordFirstLow, sub33nonWordFirstLow, sub34nonWordFirstLow, sub35nonWordFirstLow,...
    sub37nonWordFirstLow);
clear sub14nonWordFirstLow sub16nonWordFirstLow sub17nonWordFirstLow sub19nonWordFirstLow...
    sub21nonWordFirstLow sub23nonWordFirstLow sub24nonWordFirstLow sub29nonWordFirstLow...
    sub27nonWordFirstLow sub28nonWordFirstLow sub31nonWordFirstLow sub33nonWordFirstLow...
    sub34nonWordFirstLow sub35nonWordFirstLow sub37nonWordFirstLow

nonWordSecondLowSZ = ft_freqgrandaverage(cfg, sub14nonWordSecondLow, sub16nonWordSecondLow,...
    sub17nonWordSecondLow, sub19nonWordSecondLow, sub21nonWordSecondLow, sub23nonWordSecondLow,...
    sub24nonWordSecondLow, sub27nonWordSecondLow, sub28nonWordSecondLow, sub29nonWordSecondLow,...
    sub31nonWordSecondLow, sub33nonWordSecondLow, sub34nonWordSecondLow, sub35nonWordSecondLow,...
    sub37nonWordSecondLow);
clear sub14nonWordSecondLow sub16nonWordSecondLow sub17nonWordSecondLow sub19nonWordSecondLow...
    sub21nonWordSecondLow sub23nonWordSecondLow sub24nonWordSecondLow sub29nonWordSecondLow...
    sub27nonWordSecondLow sub28nonWordSecondLow sub31nonWordSecondLow sub33nonWordSecondLow...
    sub34nonWordSecondLow sub35nonWordSecondLow sub37nonWordSecondLow

nonWordSingleLowSZ = ft_freqgrandaverage(cfg, sub14nonWordSingleLow, sub16nonWordSingleLow,...
    sub17nonWordSingleLow, sub19nonWordSingleLow, sub21nonWordSingleLow, sub23nonWordSingleLow,...
    sub24nonWordSingleLow, sub27nonWordSingleLow, sub28nonWordSingleLow, sub29nonWordSingleLow,...
    sub31nonWordSingleLow, sub33nonWordSingleLow, sub34nonWordSingleLow, sub35nonWordSingleLow,...
    sub37nonWordSingleLow);
clear sub14nonWordSingleLow sub16nonWordSingleLow sub17nonWordSingleLow sub19nonWordSingleLow...
    sub21nonWordSingleLow sub23nonWordSingleLow sub24nonWordSingleLow sub29nonWordSingleLow...
    sub27nonWordSingleLow sub28nonWordSingleLow sub31nonWordSingleLow sub33nonWordSingleLow...
    sub34nonWordSingleLow sub35nonWordSingleLow sub37nonWordSingleLow

wordFirstLowSZ = ft_freqgrandaverage(cfg, sub14wordFirstLow, sub16wordFirstLow,...
    sub17wordFirstLow, sub19wordFirstLow, sub21wordFirstLow, sub23wordFirstLow,...
    sub24wordFirstLow, sub27wordFirstLow, sub28wordFirstLow, sub29wordFirstLow,...
    sub31wordFirstLow, sub33wordFirstLow, sub34wordFirstLow, sub35wordFirstLow,...
    sub37wordFirstLow);
clear sub14wordFirstLow sub16wordFirstLow sub17wordFirstLow sub19wordFirstLow...
    sub21wordFirstLow sub23wordFirstLow sub24wordFirstLow sub29wordFirstLow...
    sub27wordFirstLow sub28wordFirstLow sub31wordFirstLow sub33wordFirstLow...
    sub34wordFirstLow sub35wordFirstLow sub37wordFirstLow

wordSecondLowSZ = ft_freqgrandaverage(cfg, sub14wordSecondLow, sub16wordSecondLow,...
    sub17wordSecondLow, sub19wordSecondLow, sub21wordSecondLow, sub23wordSecondLow,...
    sub24wordSecondLow, sub27wordSecondLow, sub28wordSecondLow, sub29wordSecondLow, ...
    sub31wordSecondLow, sub33wordSecondLow, sub34wordSecondLow, sub35wordSecondLow,...
    sub37wordSecondLow);
clear sub14wordSecondLow sub16wordSecondLow sub17wordSecondLow sub19wordSecondLow...
    sub21wordSecondLow sub23wordSecondLow sub24wordSecondLow sub29wordSecondLow...
    sub27wordSecondLow sub28wordSecondLow sub31wordSecondLow sub33wordSecondLow...
    sub34wordSecondLow sub35wordSecondLow sub37wordSecondLow

wordSingleLowSZ = ft_freqgrandaverage(cfg, sub14wordSingleLow, sub16wordSingleLow,...
    sub17wordSingleLow, sub19wordSingleLow, sub21wordSingleLow, sub23wordSingleLow,...
    sub24wordSingleLow, sub27wordSingleLow, sub28wordSingleLow, sub29wordSingleLow,...
    sub31wordSingleLow, sub33wordSingleLow, sub34wordSingleLow, sub35wordSingleLow,...
    sub37wordSingleLow);
clear sub14wordSingleLow sub16wordSingleLow sub17wordSingleLow sub19wordSingleLow...
    sub21wordSingleLow sub23wordSingleLow sub24wordSingleLow sub29wordSingleLow...
    sub27wordSingleLow sub28wordSingleLow sub31wordSingleLow sub33wordSingleLow...
    sub34wordSingleLow sub35wordSingleLow sub37wordSingleLow
...
nonWordFirstLowCon = ft_freqgrandaverage(cfg, sub0nonWordFirstLow, sub1nonWordFirstLow,...
    sub2nonWordFirstLow, sub3nonWordFirstLow, sub5nonWordFirstLow, sub6nonWordFirstLow,...
    sub7nonWordFirstLow, sub8nonWordFirstLow, sub9nonWordFirstLow, sub12nonWordFirstLow,...
    sub15nonWordFirstLow, sub20nonWordFirstLow, sub32nonWordFirstLow, sub36nonWordFirstLow,...
    sub39nonWordFirstLow, sub41nonWordFirstLow);
clear sub0nonWordFirstLow sub1nonWordFirstLow sub2nonWordFirstLow sub3nonWordFirstLow...
    sub5nonWordFirstLow sub6nonWordFirstLow sub7nonWordFirstLow sub8nonWordFirstLow...
    sub9nonWordFirstLow sub12nonWordFirstLow sub15nonWordFirstLow sub20nonWordFirstLow...
    sub32nonWordFirstLow sub36nonWordFirstLow sub39nonWordFirstLow sub41nonWordFirstLow

nonWordSecondLowCon = ft_freqgrandaverage(cfg, sub0nonWordSecondLow, sub1nonWordSecondLow,...
    sub2nonWordSecondLow, sub3nonWordSecondLow, sub5nonWordSecondLow, sub6nonWordSecondLow,...
    sub7nonWordSecondLow, sub8nonWordSecondLow, sub9nonWordSecondLow, sub12nonWordSecondLow,...
    sub15nonWordSecondLow, sub20nonWordSecondLow, sub32nonWordSecondLow, sub36nonWordSecondLow,...
    sub39nonWordSecondLow, sub41nonWordSecondLow);
clear sub0nonWordSecondLow sub1nonWordSecondLow sub2nonWordSecondLow sub3nonWordSecondLow...
    sub5nonWordSecondLow sub6nonWordSecondLow sub7nonWordSecondLow sub8nonWordSecondLow...
    sub9nonWordSecondLow sub12nonWordSecondLow sub15nonWordSecondLow sub20nonWordSecondLow...
    sub32nonWordSecondLow sub36nonWordSecondLow sub39nonWordSecondLow sub41nonWordSecondLow

nonWordSingleLowCon = ft_freqgrandaverage(cfg, sub0nonWordSingleLow, sub1nonWordSingleLow,...
    sub2nonWordSingleLow, sub3nonWordSingleLow, sub5nonWordSingleLow, sub6nonWordSingleLow,...
    sub7nonWordSingleLow, sub8nonWordSingleLow, sub9nonWordSingleLow, sub12nonWordSingleLow,...
    sub15nonWordSingleLow, sub20nonWordSingleLow, sub32nonWordSingleLow, sub36nonWordSingleLow,...
    sub39nonWordSingleLow, sub41nonWordSingleLow);
clear sub0nonWordSingleLow sub1nonWordSingleLow sub2nonWordSingleLow sub3nonWordSingleLow...
    sub5nonWordSingleLow sub6nonWordSingleLow sub7nonWordSingleLow sub8nonWordSingleLow...
    sub9nonWordSingleLow sub12nonWordSingleLow sub15nonWordSingleLow sub20nonWordSingleLow...
    sub32nonWordSingleLow sub36nonWordSingleLow sub39nonWordSingleLow sub41nonWordSingleLow

wordFirstLowCon = ft_freqgrandaverage(cfg, sub0wordFirstLow, sub1wordFirstLow,...
    sub2wordFirstLow, sub3wordFirstLow, sub5wordFirstLow, sub6wordFirstLow,...
    sub7wordFirstLow, sub8wordFirstLow, sub9wordFirstLow, sub12wordFirstLow,...
    sub15wordFirstLow, sub20wordFirstLow, sub32wordFirstLow, sub36wordFirstLow,...
    sub39wordFirstLow, sub41wordFirstLow);
clear sub0wordFirstLow sub1wordFirstLow sub2wordFirstLow sub3wordFirstLow...
    sub5wordFirstLow sub6wordFirstLow sub7wordFirstLow sub8wordFirstLow...
    sub9wordFirstLow sub12wordFirstLow sub15wordFirstLow sub20wordFirstLow...
    sub32wordFirstLow sub36wordFirstLow sub39wordFirstLow sub41wordFirstLow

wordSecondLowCon = ft_freqgrandaverage(cfg, sub0wordSecondLow, sub1wordSecondLow,...
    sub2wordSecondLow, sub3wordSecondLow, sub5wordSecondLow, sub6wordSecondLow,...
    sub7wordSecondLow, sub8wordSecondLow, sub9wordSecondLow, sub12wordSecondLow,...
    sub15wordSecondLow, sub20wordSecondLow, sub32wordSecondLow, sub36wordSecondLow,...
    sub39wordSecondLow, sub41wordSecondLow);
clear sub0wordSecondLow sub1wordSecondLow sub2wordSecondLow sub3wordSecondLow...
    sub5wordSecondLow sub6wordSecondLow sub7wordSecondLow sub8wordSecondLow...
    sub9wordSecondLow sub12wordSecondLow sub15wordSecondLow sub20wordSecondLow...
    sub32wordSecondLow sub36wordSecondLow sub39wordSecondLow sub41wordSecondLow

wordSingleLowCon = ft_freqgrandaverage(cfg, sub0wordSingleLow, sub1wordSingleLow,...
    sub2wordSingleLow, sub3wordSingleLow, sub5wordSingleLow, sub6wordSingleLow,...
    sub7wordSingleLow, sub8wordSingleLow, sub9wordSingleLow, sub12wordSingleLow,...
    sub15wordSingleLow, sub20wordSingleLow, sub32wordSingleLow, sub36wordSingleLow,...
    sub39wordSingleLow, sub41wordSingleLow);
clear sub0wordSingleLow sub1wordSingleLow sub2wordSingleLow sub3wordSingleLow...
    sub5wordSingleLow sub6wordSingleLow sub7wordSingleLow sub8wordSingleLow...
    sub9wordSingleLow sub12wordSingleLow sub15wordSingleLow sub20wordSingleLow...
    sub32wordSingleLow sub36wordSingleLow sub39wordSingleLow sub41wordSingleLow
...
subplot(2,3,1)
ft_singleplotTFR(cfg, wordSingleLowSZ);
title('single word low freq')
subplot(2,3,2)
ft_singleplotTFR(cfg, wordFirstLowSZ);
title('first word low freq')
subplot(2,3,3)
ft_singleplotTFR(cfg, wordSecondLowSZ);
title('second word low freq')
subplot(2,3,4)
ft_singleplotTFR(cfg, nonWordSingleLowSZ);
title('single non-word low freq')
subplot(2,3,5)
ft_singleplotTFR(cfg, nonWordFirstLowSZ);
title('first non-word low freq')
subplot(2,3,6)
ft_singleplotTFR(cfg, nonWordSecondLowSZ);
title('second non-word low freq')
...
subplot(2,3,1)
ft_singleplotTFR(cfg, wordSingleLowSZ);
title('single word low freq SZ')
subplot(2,3,2)
ft_singleplotTFR(cfg, wordFirstLowSZ);
title('first word low freq SZ')
subplot(2,3,3)
ft_singleplotTFR(cfg, wordSecondLowSZ);
title('second word low freq SZ')
subplot(2,3,4)
ft_singleplotTFR(cfg, wordSingleLowCon);
title('single word low freq Control')
subplot(2,3,5)
ft_singleplotTFR(cfg, wordFirstLowCon);
title('first word low freq Control')
subplot(2,3,6)
ft_singleplotTFR(cfg, wordSecondLowCon);
title('second word low freq Control')
...
subplot(2,3,1)
ft_singleplotTFR(cfg, nonWordSingleLowSZ);
title('single non-word low freq SZ')
subplot(2,3,2)
ft_singleplotTFR(cfg, nonWordFirstLowSZ);
title('first non-word low freq SZ')
subplot(2,3,3)
ft_singleplotTFR(cfg, nonWordSecondLowSZ);
title('second non-word low freq SZ')
subplot(2,3,4)
ft_singleplotTFR(cfg, nonWordSingleLowCon);
title('single non-word low freq Control')
subplot(2,3,5)
ft_singleplotTFR(cfg, nonWordFirstLowCon);
title('first non-word low freq Control')
subplot(2,3,6)
ft_singleplotTFR(cfg, nonWordSecondLowCon);
title('second non-word low freq Control')
...
All = nonWordFirstLowSZ;
All.powspctrm = [nonWordFirstLowSZ.powspctrm; nonWordSecondLowSZ.powspctrm;...
    nonWordSingleLowSZ.powspctrm; wordFirstLowSZ.powspctrm;...
    wordSecondLowSZ.powspctrm; wordSingleLowSZ.powspctrm;...
    nonWordFirstLowCon.powspctrm; nonWordSecondLowCon.powspctrm;...
    nonWordSingleLowCon.powspctrm; wordFirstLowCon.powspctrm;...
    wordSecondLowCon.powspctrm; wordSingleLowCon.powspctrm];
SZ = nonWordFirstLowSZ;
SZ.powspctrm = [nonWordFirstLowSZ.powspctrm; nonWordSecondLowSZ.powspctrm;...
    nonWordSingleLowSZ.powspctrm; wordFirstLowSZ.powspctrm;...
    wordSecondLowSZ.powspctrm; wordSingleLowSZ.powspctrm];
Con = nonWordFirstLowCon;
Con.powspctrm = [nonWordFirstLowCon.powspctrm; nonWordSecondLowCon.powspctrm;...
    nonWordSingleLowCon.powspctrm; wordFirstLowCon.powspctrm;...
    wordSecondLowCon.powspctrm; wordSingleLowCon.powspctrm];
...
title('All conds both groups low freq')
figure;
subplot(1,3,1)
ft_singleplotTFR(cfg, SZ_Con);
title('SZ minus Con low freq')
subplot(1,3,2)
